                            ...
                            >
                                <div className="relative mb-3">
                                    ...
                                    employee.avatar ? (
                                        ...
                                        <div
                                            className={`w-16 h-16 rounded-full ${color.avatar} flex items-center justify-center text-white font-bold text-base tracking-wide shadow-sm`}
                                        >
                                            {employee.initials}
                                        </div>
                                    )}
                                ...
                                <div className="flex flex-col items-center">
                                    <span
                                        className={`text-sm font-bold ${color.name} tracking-tight`}
                                    >
                                        {employee.name}
                                    </span>
                                    <span
                                        className={`text-xs font-medium mt-0.5 mb-3 ${color.dept}`}
                                    >
                                        {employee.department}
                                    </span>
                                </div>
                                ...
                                <div className="mt-auto">
                                    <span
                                        className={`inline-block text-[10px] font-bold px-3 py-1 rounded-full tracking-wide shadow-sm ${employee.is_today ? color.pillToday : color.pill}`}
                                    >
