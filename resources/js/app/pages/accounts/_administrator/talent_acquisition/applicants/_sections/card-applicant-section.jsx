...
export default function CardApplicantSection() {
    ...
    const filteredApplications = useMemo(() => {
        ...
        // Optimization: return early if no filters are applied
        ...
        <div className="flex bg-gray-100 gap-6 flex-wrap w-full justify-start items-start">
            {filteredApplications?.length > 0 ? (
                filteredApplications.map((res) => {
                    ...
                    // 2. Employee Badging & Name Logic (Optimized nested checks)
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                <div className="flex items-center justify-between gap-2">
                                    <span className="font-medium text-gray-500 flex items-center gap-1.5 shrink-0">
                                        <Briefcase className="w-4 h-4 text-purple-600" /> Position
                                    </span>
                                    <span className="text-gray-900 font-medium text-right truncate">
                                        {jobRequisition?.title || 'N/A'}
                                    </span>
                                </div>
                                ...
                                <div className="flex items-center justify-between gap-2">
                                    <span className="font-medium text-gray-500 flex items-center gap-1.5 shrink-0">
                                        <UserCheck className="w-4 h-4 text-purple-600" /> Recruiter
                                    </span>
                                    <span className="text-gray-900 font-medium text-right truncate">
                                        {jobRequisition?.recruiter?.name || 'Unassigned'}
                                    </span>
                                </div>
                                ...
                                <div className="flex items-center justify-between gap-2">
                                    <span className="font-medium text-gray-500 flex items-center gap-1.5 shrink-0">
                                        <Building className="w-4 h-4 text-purple-600" /> Account
                                    </span>
                                    <span className="text-gray-900 font-medium text-right truncate">
                                        {jobRequisition?.account?.name || 'Unassigned'}
                                    </span>
                                </div>
                                ...
                                <div className="flex items-center justify-between gap-2 pt-1 border-t w-full border-gray-50">
                                    <span className="font-medium text-gray-500 flex items-center gap-1.5 shrink-0">
                                        <Calendar className="w-4 h-4 text-purple-600" /> Interview
                                    </span>
                                    <div>
                                        {scheduledDate ? (
                                            <button
                                            ...
                                            >
                                                ...
                                                <div className="flex gap-3 items-center leading-tight">
                                                    ...
                                                    <span className="text-[10px] text-gray-500 font-medium">
                                                        {res.schedule?.start_time ? moment(res.schedule.start_time, 'HH:mm:ss').format('h:mm A') : ''}
                                                    </span>
                                                </div>
                                            </button>
                                        ) : (
