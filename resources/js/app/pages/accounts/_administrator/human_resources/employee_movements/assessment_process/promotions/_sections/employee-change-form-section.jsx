...
const EmployeeChangeFormSection = ({ props_data }) => {
    ...
    useEffect(() => {
        ...
        if (
            leader_information?.id != new_position_information?.user?.id &&
            new_position_information?.user?.id != undefined
        ) {
        ...
        setValue(
            "name",
            `${props_data?.applicant?.personal_information?.first_name || ""} ${props_data?.applicant?.personal_information?.last_name || ""
                }`.trim()
        );
    }, []);
    ...
    useEffect(() => {
        if (new_report) {
            setValue(
                "info_reporting_to",
                `${new_report?.user?.personal_information?.first_name} ${new_report?.user?.personal_information?.last_name}`
            );
        }
    ...
    useEffect(() => {
        if (employee_information) {
            const reportingName =
                `${leader_information?.personal_information?.first_name || ""} ${leader_information?.personal_information?.last_name || ""
                    }`.trim();
            ...
            >
                ...
                >
                    ...
                    <div className="mb-6 flex items-start flex-col gap-3 w-full text-sm">
                        ...
                        <div className="flex gap-3 items-start justify-center w-full">
                            ...
                            <Checkbox
                                ...
                                onChange={(val) =>
                                    setValue("is_account_transfer", val.target.checked)
                                }
                            />
                            ...
                            <Checkbox
                                ...
                                onChange={(val) =>
                                    setValue("is_department_transfer", val.target.checked)
                                }
                            />
                            ...
                            <Checkbox
                                ...
                                onChange={(val) =>
                                    setValue("is_position_and_title", val.target.checked)
                                }
                            />
                        ...
                        {watchedValues.is_tiering && (
                            <Select
                                ...
                                onChange={(val) =>
                                    setValue("ecf_id", val, { shouldValidate: true })
                                }
                        ...
                        <table className="w-full border-collapse border border-black text-sm text-center mb-6">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th className="border border-black p-1 w-[5%]">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                {/* Position Level */}
                                <tr>
                                    ...
                                    <td className="border border-black p-1">
                                        <Input
                                            type="text"
                                            {...register("info_position_level_from", {
                                                required: true,
                                            })}
                                            disabled
                                            className="bg-transparent w-full outline-none text-center text-black"
                                ...
                                <tr>
                                    ...
                                    <td className="border border-black p-1">
                                        ...
                                        >
                                            {watchedValues.is_edit_reporting_to ? "Cancel" : "Edit"}
                                        </Button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td className="border border-black p-1">
                                        ...
                                        >
                                            {watchedValues.is_edit_basic_pay ? "Cancel" : "Edit"}
                                        </Button>
                                    </td>
                                </tr>
                            </tbody>
                                ...
                                <tbody>
                                    {fields.length === 0 ? (
                                        <tr>
                                            <td
                                                colSpan="4"
                                                className="p-2 border border-black italic text-gray-500"
                                            >
                                                No allowances added. Click "+ Add Allowance" above to
                                                add dynamic fields.
                                            </td>
                                        </tr>
                                    ) : (
                                            ...
                                            <tr key={field.id}>
                                                ...
                                                <td className="border border-black p-1">
                                                    <Select
                                                        ...
                                                        onChange={(val) =>
                                                            setValue(`allowances.${index}.name`, val, {
                                                                shouldValidate: true,
                                                            })
                                                        }
                                                    />
                                                ...
                                                <td className="border border-black p-1">
                                                    <Input
                                                        type="number"
                                                        {...register(`allowances.${index}.amount_from`, {
                                                            required: true,
                                                        })}
                                                        className="bg-transparent w-full outline-none text-center text-black"
                                                ...
                                                <td className="border border-black p-1">
                                                    <Input
                                                        type="number"
                                                        {...register(`allowances.${index}.amount_to`, {
                                                            required: true,
                                                        })}
                                                        className="bg-transparent w-full outline-none text-center text-black"
                    ...
                    <TextArea
                        ...
                        onChange={(val) =>
                            setValue("notes", val.target.value)
                        }
                    />
                    ...
                    <div className="mt-8 text-sm">
                        ...
                        <div className="flex justify-between items-end mb-12">
                            ...
                            <div className="text-[10px] text-gray-700">
                                *It is not a guaranteed allowance and may be removed by the
                                program
                            </div>
                        </div>
                    </div>
