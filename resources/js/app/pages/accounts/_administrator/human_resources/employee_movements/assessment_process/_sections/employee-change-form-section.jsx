...
const EmployeeChangeFormSection = ({ props_data }) => {
    ...
    console.log('agent_account', props_data)
    ...
    useEffect(() => {
        ...
        setValue('name', `${props_data?.user?.personal_information?.first_name} ${props_data?.user?.personal_information?.last_name}`)
    ...
    useEffect(() => {
        if (employee_information) {
            ...
            const fieldUpdates = {
                ...
                info_reporting_id_from: leader_information?.user_id,
                info_reporting_id_to: leader_information?.user_id,
