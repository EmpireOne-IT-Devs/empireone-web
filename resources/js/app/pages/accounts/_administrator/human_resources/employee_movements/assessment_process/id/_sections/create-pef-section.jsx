...
const CreatePEFSection = () => {
    ...
    // Added hasError prop to show red border if rating is missed
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            {[
                                {
                                    label: "Job Knowledge",
                                    key: "job_knowledge",
                                    desc: "Application, Technical and Professional skills",
                                },
                                {
                                    label: "Communication Skills",
                                    key: "communication",
                                    desc: "Communicates effectively to clients/individuals",
                                },
                                {
                                    label: "Management Skills",
                                    key: "management",
                                    desc: "Leads team to get desired results",
                                },
                                {
                                    label: "Organizing Skills",
                                    key: "organizing",
                                    desc: "Sets priorities for tasks and commitments",
                                },
                                {
                                    label: "Initiative",
                                    key: "initiative",
                                    desc: "Commitment to seek improvements",
                                },
                                {
                                    label: "Discipline",
                                    key: "discipline",
                                    desc: "Adherence to provisions in Code of Conduct",
                                },
                                {
                                    label: "Attendance",
                                    key: "attendance",
                                    desc: "Adherence to provisions in Attendance policy",
                                },
                            ].map((item) => (
                                <tr
                                    key={item.key}
                                ...
                                >
                                    ...
                                    <td className="border-l p-2 align-middle bg-blue-50/30">
                                        <RatingRadioGroup
                                            name={`performance.${item.key}.mgr`}
                                            hasError={
                                                !!errors.performance?.[item.key]
                                                    ?.mgr
                                            }
                                        />
                                    </td>
                ...
                <div className="mt-12 grid grid-cols-2 gap-12 px-6">
                    ...
                    <div className="flex items-end justify-center h-full">
                        <div className="border-t-2 border-gray-800 pt-2 text-center group cursor-pointer hover:bg-gray-50 rounded transition-colors pb-4 flex items-end justify-center w-full">
                            <p className="text-sm font-bold uppercase text-gray-800">
                ...
                <div className="flex justify-center mt-10 pt-6 border-t border-gray-200">
                    <button
                        type="submit"
                        className="bg-blue-600 text-white px-12 py-4 font-black tracking-wider rounded shadow-xl hover:bg-blue-700 hover:-translate-y-1 hover:shadow-2xl active:translate-y-0 active:shadow-md transition-all duration-200"
                    >
                        SUBMIT EVALUATION
                    </button>
                </div>
