    ...
    return (
        <Card variant="default" padding="p-0" className="w-full overflow-hidden font-sans">
            <div className="w-full bg-gradient-to-r from-orange-600 via-orange-500 to-amber-500 px-5 py-4 flex items-center gap-3">
                ...
                <div>
                    <p className="text-white font-bold text-sm leading-tight">{post.headline}</p>
            ...
            <div className="px-5 py-4 flex flex-col gap-3">
                <div className="flex items-center gap-2.5">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-400 mt-0.5">Activities • {post.time_ago}</p>
                    </div>
                </div>

                <PostHtmlContent html={post.message} className="text-sm text-gray-700 leading-relaxed" />
                ...
                {celebrants.length > 0 && (
                    <div className="border border-purple-100 bg-purple-50/50 rounded-xl p-3.5 flex flex-col gap-2">
                        <p className="text-xs font-bold text-purple-500 uppercase tracking-wider">
                            🎂 Birthday Celebrant{celebrants.length !== 1 ? "s" : ""} of the Month
                        </p>
    ...
    return (
        <Card variant="default" padding="p-0" className="w-full overflow-hidden font-sans">
                ...
                <div className="flex items-center gap-2.5">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-1.5 mt-0.5">
                            <p className="text-xs text-gray-400">Activities • {post.time_ago}</p>
            ...
            <div className="px-4 pb-3 flex flex-col gap-1">
                ...
                <PostHtmlContent html={post.message} className="text-gray-600 text-sm leading-relaxed" />
            </div>
