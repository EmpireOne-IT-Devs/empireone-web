                            ...
                            return (
                                ...
                                >
                                    <div className="flex items-center gap-3.5 min-w-0">
                                        <span className="w-4 text-center text-xs font-bold text-gray-400">{idx + 1}</span>
                                        ...
                                        <div className="flex flex-col min-w-0">
                                            <span className="text-sm font-bold text-gray-800 tracking-tight truncate">{user.name}</span>
                                            <span className="text-[11px] text-gray-400 font-medium mt-0.5">{user.department}</span>
                                        </div>
                                    </div>
