...
export default function SidebarSection() {
    ...
    const navigation = [
        ...
        {
            name: "Reward Store",
            href: "/employee/rewards_store",
            icon: FcShop,
            current: path == "rewards_store",
        },
        {
            name: "My Applications",
            href: "/employee/my_applications",
            icon: FcDocument,
            current: path == "my_applications",
        },
        {
            name: "Job Offers",
            href: "/employee/job_offers",
            icon: FcFeedback,
