        ...
        <div className="flex gap-3 w-full">
            <Card className="w-full flex-col gap-3 ">
                ...
                <div className="flex-col flex items-start justify-between">
                    <div>3</div>
                    <div>Active Postings</div>
                    <div className="text-green-500">+ 2 this week</div>
                </div>
            </Card>
            <Card className="w-full flex-col gap-3">
                <div className="flex-row flex items-start justify-between">
                ...
                <div className="flex-col flex items-start justify-between">
                    ...
                    <div className="text-green-500">+ 18% this week</div>
                </div>
            </Card>
            <Card className="w-full flex-col gap-3">
                <div className="flex-row flex items-start justify-between">
                ...
                <div className="flex-col flex items-start justify-between">
                    ...
                    <div className="text-green-500">8 this week</div>
                </div>
            </Card>
            <Card className="w-full flex-col gap-3">
                <div className="flex-row flex items-start justify-between">
                ...
                <div className="flex-col flex items-start justify-between ">
                    ...
                    <div className="text-green-500">3 this months</div>
                </div>
            </Card>
        </div>
    );
