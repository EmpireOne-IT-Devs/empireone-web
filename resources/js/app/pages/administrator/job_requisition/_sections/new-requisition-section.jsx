                  ...
                  <div className="space-y-3">
                    <label className="flex items-start gap-3 cursor-pointer">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-500">
                          Create a requisition for a brand new position
                        </div>
                      </div>
                    </label>
                    ...
                    <label className="flex items-start gap-3 cursor-pointer">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-500">
                          Request additional headcount for an existing role
                        </div>
                      </div>
                    </label>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <Controller
                    ...
                    control={control}
                    rules={{ required: "Target Start Date is required" }}
                    render={({ field }) => (
                      <Input
                        {...field}
                ...
                render={({ field }) => (
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Justification for Position <span className="text-red-500">*</span>
                    </label>
                    <textarea
                      {...field}
                    ...
                    {errors.justification_for_position && (
                      <p className="text-red-500 text-sm mt-1">
                        {errors.justification_for_position.message}
                      </p>
                    )}
                  </div>
                )}
            ...
            <div>
              ...
              <div className="space-y-4">
                <Controller
                  ...
                  control={control}
                  rules={{ required: "Required qualifications are required" }}
                  render={({ field }) => (
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                      ...
                      {errors.required_qualifications && (
                        <p className="text-red-500 text-sm mt-1">
                          {errors.required_qualifications.message}
                        </p>
                      )}
                    </div>
                  )}
                  ...
                  render={({ field }) => (
                    <div>
                      ...
                      {errors.key_responsibilities && (
                        <p className="text-red-500 text-sm mt-1">
                          {errors.key_responsibilities.message}
                        </p>
                      )}
                    </div>
                  )}
