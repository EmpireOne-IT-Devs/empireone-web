...
<body>
    <div class="wrapper">
        <div class="card">
            <div class="header">
                <h1>Job Offer Declined! 🚫</h1>
            </div>
            <div class="content">
                <p>Hi <strong>HR Team</strong>,</p>

                <p>This is an automated notification to let you know that <strong>{{ $user['user']['name'] }}</strong> has officially declined the job offer for the <strong>{{ $user['job_application']['job_posting']['job_requisition']['title'] }}</strong> position.</p>
                ...
                <p><strong>Reason: {{$user['declined_reason']}}</strong></p>
                ...
                <div class="button-container">
                    <a href="{{ config('app.url') }}/accounts/administrator/talent_acquisition/job_offers?job_order_id={{$user['id']}}"
