...
use App\Http\Controllers\API\ER\ERExitClearanceController;
use App\Http\Controllers\API\ER\ERExitInterviewController;
...
Route::post('add_consultation',  [BookingController::class, 'add_consultation']);
